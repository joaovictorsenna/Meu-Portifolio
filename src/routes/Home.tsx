...
import { logos } from "../util/logotypes";
...
const techLogos = [
    ...
    { src: logos.typescriptLogo, alt: "TypeScript logo", name: "TypeScript", isSvg: true },
    { src: logos.nextjsLogo, alt: "nextjsLogo", name: "NextJS", isSvg: true },

    { src: logos.pythonLogo, alt: "Python logo", name: "Python", isSvg: true },
    { src: logos.javaLogo, alt: "JAVA logo", name: "JAVA", isSvg: true },

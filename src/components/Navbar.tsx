...
const Navbar = () => {
    return (
        <NavbarContainer>
            <Card>
                <SocialContainer href="https://www.instagram.com/sennaa_dev/" target="_blank" color="#d62976" className="containerOne"  >
                ...
                <SocialContainer href="https://github.com/joaovictorsenna" target="_blank" color="#00acee" className="containerTwo">
                ...
                <SocialContainer href="https://www.linkedin.com/in/joão-victor-sena-lopes/" target="_blank" color="#0072b1" className="containerThree">
